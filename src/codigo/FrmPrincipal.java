...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void btnAnalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarActionPerformed
        ...
        try {
            ...
            escribir.print(txtEntrada.getText().replaceAll("\\s+", ""));
            escribir.close();
        ...
        try {
            ...
            Lexer lexer = new Lexer(lector); //A lexer reader that read the archivo.txt file
            String resultado = "";
            boolean isValidExpresion = true;
            while (isValidExpresion) {
